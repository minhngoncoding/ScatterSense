...
def Pre_load_nets(type, id_cuda, data_dir, cache_dir):
    ...
    if type == "Line":
        db_line, nnet_line = load_net(45000, "CornerNetLine", data_dir, cache_dir,
                                      id_cuda)
...
if __name__ == "__main__":
    args = parse_args()
    cache_path = args.data_dir + "/cache"
    methods = Pre_load_nets(args.type, 0, args.data_dir, cache_path)
