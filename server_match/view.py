...
from test_fullchart import test
from django.shortcuts import render
import base64
import torch.cuda
from PIL import Image

cat2id = {0: "Scatter", 1: "Box", 2: "Mixed"}
Lock = False
    ...
    if not Lock:
        if request.method == "POST":
            ...
            try:
                ...
                plot_area, image_painted, data, chart_data = test(
                    "static/target.png",
                ...
                if chart_data[0] == 0:
                    ...
                    for k in range(len(data)):
                        for j in range(len(data[k])):
                            data[k][j] = round(
                                (max_value - min_value) * data[k][j] + min_value, 2
                            )
                ...
                context = {
                    "data": print_data,
                    "image": str_format_ori,
                    "image_painted": str_format_tar,
                    "plot_area": plot_area,
